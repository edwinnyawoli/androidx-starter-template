...
package com.edwinnyawoli.templateapplication.common;
...
public class CommonRegex {
    ...
    public static final Pattern GH_PHONE_NUMBER_PATTERN = Pattern.compile("^(?:020|050|023|024|054|055|026|056|027|057|028)\\d{7}$");
}
